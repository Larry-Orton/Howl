...
from howl.config import PROJECT_ROOT
...
def get_current_version() -> str:
    """Return the installed Howl version string."""
...
def run_update(verbose: bool = True) -> bool:
    ...
    if not _is_git_repo(PROJECT_ROOT):
        ...
        _print("    Re-clone from https://github.com/Larry-Orton/Howl and re-install.")
        return False
    ...
    _print("")
    _print("  ✓ Update complete! Restart howl to use the new version.")
    return True
